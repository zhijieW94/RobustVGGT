...
"""
AerialMegaDepth Dataset using WAI format data.
"""
...
class AerialMegaDepthWAI(BaseDataset):
    """
    AerialMegaDepth dataset containing outdoor phototourism and in-the-wild scenes.
    """
    ...
    def _load_data(self):
        ...
        split_metadata_path = os.path.join(
            ...
            self.split,
            f"aerialmegadepth_scene_list_{self.split}.npy",
        )
...
def get_parser():
    ...
    parser.add_argument(
        "-rd", "--root_dir", default="/fsx/xrtech/data/aerialmegadepth", type=str
    )
    parser.add_argument(
        "-dmd",
        "--dataset_metadata_dir",
...
if __name__ == "__main__":
    ...
    if args.viz:
        rr.script_setup(args, "AerialMegaDepth_Dataloader")
